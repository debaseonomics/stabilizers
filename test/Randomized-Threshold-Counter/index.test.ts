...
describe('Debase/Dai Randomized Counter', function() {
	...
	describe('Deploy and Initialize', function() {
		...
		before(async function() {
			...
			await randomizedCounter.setRevokeRewardDuration(revokeRewardDuration);
		});
		...
		describe('Initial settings check', function() {
			...
			it('Revoke Reward Percentage should be correct', async function() {
				expect(await randomizedCounter.revokeRewardPercentage()).eq(revokePercentage);
			});
